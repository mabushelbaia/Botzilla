...
class Management(commands.Cog): 
    ...
    async def about(self, ctx: discord.Interaction, member: discord.Member):
        ...
        embed = discord.Embed(title=member.global_name or member.name + "'s Information", color=color)
    ...
    async def server(self, ctx: discord.Interaction):
        ...
        # embed.description = f"📎 | ** [Invite Link](https://discord.gg/mAea8Ekqq9) ** \n 📎 | ** [Steam Group](https://steamcommunity.com) ** "
        await ctx.response.send_message(embed=embed)
